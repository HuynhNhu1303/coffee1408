...
<div class="container"> 
 ...
 <div class="row"> 
  <div class="col-xs-12 col-sm-12 col-md-5 well well-sm col-md-offset-4"> 
   ...
   <form  action="index.php?action=signup&act=dangky_action" method="post" class="form" role="form"> 
    <div class="row"> 
     <div class="col-xs-4 col-md-4"> <label for="email">Tên Khách Hàng:</label>
     </div>
     <div class="col-xs-8 col-md-8"><input class="form-control" name="txtten_khachhang" placeholder="Tên khách hàng" required="" autofocus="" type="text"> </div> 
     ...
     <div class="col-xs-8 col-md-8"><input class="form-control" name="txtsodienthoai" placeholder="Số điện thoại khách hàng" required="" autofocus="" type="text"> </div> 
     ...
     <input class="form-control" name="txtmatkhau" placeholder="Mật khẩu" type="password">
